               ...
               <!-- Boxes -->
                  ...
                  <!--div width="100%">
                     ...
                     <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        ...
                        try{
                           ...
                           sql = "update listboard set view="+view+" where id="+idx;
                        ...
                        %>
                        <form name='form1' action="delete_ok.jsp?idx=<%=idx %>">
                        ...
                        <input type="button" value="목록" onclick="window.location='review_list.jsp'" style="margin-right:20px;"/>
                        <!-- 로그인시에만 수정 가능 -->
                        ...
                        onclick="notlog()"
                        <%}else{ %>
                        onclick="window.location='review_edit.jsp?idx=<%=idx %>'"
                        <%} %>
                        />
                        <!-- 로그인시에만 삭제 가능 -->
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                           ...
                           <tr>
                              ...
                              <td colspan=3>
                              <input type="text" name="comment"><input type="hidden" name="refnum" value="<%=idx%>"></td>
                              ...
                              try{
                                 Class.forName(jdbc_driver);
                                 conn = DriverManager.getConnection(jdbc_url, "root", "q1w2e3r4");
                                 String sql = "select * from comment where refnum = "+idx;
                                 pstmt = conn.prepareStatement(sql);
                                 ResultSet rs = pstmt.executeQuery();
                                 String comm_writer;
                                 String comm_content;
                              ...
                              <tr>
                                 ...
                                 <td width=10%>
                                    ...
                                    <a href="comm_delete_ok.jsp?comm_num=<%=comm_num%>&ref_num=<%=idx%>" style="cursor:pointer"><font color="yellow"><u>삭제</u></font></a>
                                    <% } else {} %>
                                 </td>
                              </tr>
                                 <% }
